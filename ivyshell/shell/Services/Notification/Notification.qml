...
Variants {
    ...
    delegate: WlrLayershell {
        ...
        screen:  modelData
        visible: modelData.name === Displays.primary && !NotiServer.dnd
        ...
        ListView {
            ...
            add:    Transition { NumberAnimation { property: "x"; from: notifList.width; to: 0; duration: 400; easing.type: Easing.OutExpo } }
            remove: Transition { NumberAnimation { property: "x"; from: 0; to: notifList.width; duration: 400; easing.type: Easing.OutExpo } }
